...
class Simulation:
	def __init__(self, C=np.array([0, 1]), D=2, base_functions=np.array([Base_Func_1(), Base_Func_1()]), drift_rate=0, drift_over_time=1000, sudden_drift=False, drift_moments=np.array([]), std=0):
		self.C = C
